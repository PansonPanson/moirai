...
import top.panson.moiraicore.constant.HttpMediaType;
import top.panson.moiraicore.constant.HttpResponseCode;
...
import top.panson.moiraicore.util.LogMessage;
    ...
    private static HttpClientResponse doExecute(HttpURLConnection connection, Object body, Map<String, String> headers) {
        try {
            ...
            if (!StringUtil.isEmpty(bodyString)) {
                ...
                connection.setRequestProperty(HttpHeaderConstants.CONTENT_LENGTH, String.valueOf(b.length));
